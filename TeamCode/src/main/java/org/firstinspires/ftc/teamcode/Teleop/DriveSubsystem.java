...
import org.firstinspires.ftc.teamcode.Teleop.RotationConstants;
...
public class DriveSubsystem extends SubsystemBase {
    ...
    //USE THIS METHOD
    public void driveRobotCentricReal(double strafe, double forward, double turn) {
        controller.driveRobotCentric(strafe, forward, turn);
    }
    public void driveFieldCentricReal(double strafe, double forward, double turn, double heading) {
        controller.driveFieldCentric(strafe, forward, turn, heading);
    }
